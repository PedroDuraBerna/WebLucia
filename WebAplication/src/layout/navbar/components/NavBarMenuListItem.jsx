import { AccountCircle, AppRegistration, Home, Info, Login, Logout, Mail, Notifications, QuestionMark } from '@mui/icons-material';
            ...
            >
                <ListItemButton sx={{
                    ...
                    <ListItemIcon sx={{
                        ...
                        {/* { xs: palette.primary.main, md: palette.secondary.main } */}
                        <ListItemText
                            primary={text}
